...
import { PAGE_GROUPS, flattenGroups, GroupIcon, TreeIndent } from '../features/system-admin/PageTreeHelpers';
...
export default function SystemAdmin() {
  ...
  const handleSelectUser = (userId) => {
    ...
    // 백엔드 @ViewLog가 GET /api/admin/users/{userId} 호출 시 자동 기록
  };
      ...
      <div className="page-header">
        <div className="page-header-left">
          <h1 className="page-title">
            <i className="bi bi-shield-lock"></i> 사용자 관리
          </h1>
          <span className="page-subtitle">사용자 계정 및 권한을 관리합니다</span>
        </div>
      </div>
