...
import WatchContextMenu from '../features/realtime-performance/components/WatchContextMenu';
import RegularGroupContextMenu from '../features/realtime-performance/components/RegularGroupContextMenu';
import RegularGroupNode from '../features/realtime-performance/components/RegularGroupNode';
import { restrictHorizontalToWindow, SortableDeviceCard, WatchGroupNode } from '../features/realtime-performance/components/SortableDeviceCardAndNodes';
import { DndContext, closestCenter, PointerSensor, useSensor, useSensors } from '@dnd-kit/core';
import { SortableContext, rectSortingStrategy, arrayMove } from '@dnd-kit/sortable';
import '../styles/realtime-performance.css';
import '../styles/realtime-performance-light.css';
            ...
            <>
              ...
              <div className="watch-header">
                <div className="watch-header-left">
                  ...
                  <div className={`fault-live-chip ${isWatching && sseConnected ? '' : 'live-inactive'}`} style={{ '--border-color': '#10b981' }}>
                    <span className="fault-live-border" />
                    <span className="fault-live-dot" />
                    <span className="fault-live-label">
                      {isWatching ? (sseConnected ? 'LIVE' : '연결 중...') : 'LIVE'}
                    </span>
                  </div>
